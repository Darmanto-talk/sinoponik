                ...
                <div class="col-lg-6">
                    ...
                    <ul class="accordion-box">
                        ...
                        <li class="accordion block active-block">
                            <div class="acc-btn active">Alamat Website<span class="icon fa fa-plus"></span></div>
                            <div class="acc-content current">
                                <div class="content">
                                    <p>Official Website <a href="https://sinoponik.politap.ac.id">https://sinoponik.politap.ac.id </a> </p>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="accordion block">
                            <div class="acc-btn">Kontak Kami <span class="icon fa fa-plus"></span></div>
                            <div class="acc-content">
                                <div class="content">
                                    <p><b>email : sinoponik@politap.ac.id </br>
                                    Muh Anhar : +62 812-2664-5949</br>
                                    Betti Ses Eka Polonia : +62 812-5477-2992</b></p>
                                </div>
                            </div>
                        </li>
